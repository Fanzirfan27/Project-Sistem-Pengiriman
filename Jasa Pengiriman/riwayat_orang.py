...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_7.setGeometry(QtCore.QRect(275, 30, 350, 31))
        font = QtGui.QFont()
        ...
        self.table_widget.setGeometry(QtCore.QRect(20, 70, 870, 580))
        self.table_widget.setColumnCount(9)
        self.table_widget.setHorizontalHeaderLabels([
            "ID", "Nama Pemesan", "Alamat Pemesan", "Alamat Tujuan",
            "Kategori", "Status", "Harga", "Voucher", "Status Pembayaran"
        ])
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Log Riwayat Pengantaran Orang"))
        self.label_7.setText(_translate("MainWindow", "Log Riwayat Pengantaran Orang"))
